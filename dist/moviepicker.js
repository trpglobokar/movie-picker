...
var _allmovies = require("./renders/allmovies");
...
var _randomSelect = require("./renders/randomSelect");
...
var theme = (0, _styles.createMuiTheme)({
  ...
  typography: {
    fontFamily: ['Raleway', 'typeface-roboto', 'Roboto', '"Helvetica Neue"', 'Arial', 'sans-serif', '"Apple Color Emoji"', '"Segoe UI Emoji"', '"Segoe UI Symbol"'].join(','),
